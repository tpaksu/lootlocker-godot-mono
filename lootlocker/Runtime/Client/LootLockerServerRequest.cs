...
namespace LootLocker
{
    ...
    public static class LootLockerHttpMethodConverter
    {
        public static System.Net.Http.HttpMethod ToHttpMethod(this LootLockerHTTPMethod method)
        {
            return method switch
            {
                LootLockerHTTPMethod.GET => HttpMethod.Get,
                LootLockerHTTPMethod.POST => HttpMethod.Post,
                LootLockerHTTPMethod.DELETE => HttpMethod.Delete,
                LootLockerHTTPMethod.PUT => HttpMethod.Put,
                LootLockerHTTPMethod.HEAD => HttpMethod.Head,
                LootLockerHTTPMethod.CREATE => HttpMethod.Post,
                LootLockerHTTPMethod.OPTIONS => HttpMethod.Options,
                LootLockerHTTPMethod.PATCH => HttpMethod.Patch,
                LootLockerHTTPMethod.UPDATE_FILE => HttpMethod.Put,
                LootLockerHTTPMethod.UPLOAD_FILE => HttpMethod.Put,
                _ => null
            };
        }
    }
    ...
    public struct LootLockerServerRequest
    {
            ...
            Dictionary<string, string> extraHeaders = null, bool useAuthToken = true, LootLocker.LootLockerEnums.LootLockerCallerRole callerRole = LootLocker.LootLockerEnums.LootLockerCallerRole.User, bool isFileUpload = true)
        {
            ...
            var formData = new FormUrlEncodedContent(body.ToArray());
            this.form.Add(formData);
            this.form.Add(new ByteArrayContent(upload), uploadName);
